...
$key='AIzaSyCeuqFvCLycGBNxYYDD-ZrlGbstuB8Nkhw';
...
".'<script src="https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
     ...
     <body style="background-color: #f8f8f8;">
        <div class="w3-container w3-red w3-center" style="height:55px">
           <img src="'.Root_part().'logo.png" alt="logo" style="height:35px;margin: 10px 0" />
        </div>';


$footer='<footer class="w3-container w3-red w3-center" style="width: 100%;bottom: 0px;">
            <p>©By <a href="https://stefanzhang.com/" target="_blank">Stefan</a></p>
        </footer>
        </body>
</html>';
...
echo '<script>
    ...
    default:
        ...
        $(\'.searchTerm\').tw_input_placeholder({
            speed: 100,
            delay: 2000,
            keywords: [\'可以输入一个Youtube视频链接\', \'或者是输入一个关键词搜索\']
        });
        </script></div></div>';
